          ...
          [
            ...
            function (t, e) {
              ...
              for (var w = 0, _ = 0, P = []; _ < p.length; ) {
                ...
                var S,
                  x = u(y, h ? p : p.slice(_));
                if (null === x || (S = f(c(y.lastIndex + (h ? 0 : _)), p.length)) === w)
                  _ = a(p, _, g);
                else {
          ...
          a &&
            ...
            p.publicLoader.loadPage(l.pathname).then(function (t) {
              ...
              var n = function () {
                ...
                s = Object(r.apiRunner)('replaceHydrateFunction', void 0, c.a.hydrate)[0];
              f()(function () {
                s(
          ...
          return (
            ...
            (e.prototype.componentDidMount = function () {
              var t = this.props,
                ...
                c = p(t, ['navigate', 'to', 'from', 'replace', 'state', 'noThrow', 'baseuri']);
              Promise.resolve().then(function () {
        ...
        'Array',
        {
          from: function (t) {
            ...
            if (
              ...
              for (n = new d((e = u(p.length))); e > m; m++) s(n, m, g ? v(p[m], m) : p[m]);
            else

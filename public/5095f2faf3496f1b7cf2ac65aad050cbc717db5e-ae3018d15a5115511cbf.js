  ...
  [0],
  {
    ...
    '9eSz': function (e, t, n) {
      ...
      var T = (function (e) {
        function t(t) {
          ...
          var r = n.isCritical || (b && (v || !n.useIOSupport));
          return (
            (n.state = {
              isVisible: r,
              imgLoaded: !1,
        ...
        return (
          ...
          (n.render = function () {
            var e = d(this.props),
              ...
              N = 'boolean' == typeof v ? 'lightgray' : v,
              L = { transitionDelay: b + 'ms' },
              z = (0, c.default)({ opacity: this.state.imgLoaded ? 0 : 1 }, T && L, {}, s, {}, f),
              P = {
                title: t,
    ...
    Kvkj: function (e, t, n) {
      ...
      var r = n('VEi9'),
        ...
        c = function (e) {
          var t = e.title,
            ...
            l = r.data.site.siteMetadata,
            u = l.defaultTitle,
            d = l.defaultDescription,
            f = l.siteUrl,
            p = l.defaultImage,
            h = l.twitterUsername,
            m = { title: t || u, description: n || d, image: '' + f + (a || p), url: '' + f + c };
      ...
      var u = n('vOnD'),
        ...
        p = (n('pJf4'), n('rzGZ'), n('Dq+y'), n('8npG'), n('PZd/'), n('o/VY')),
        h = n.n(p),
        m = n('L+mo'),
        g = n.n(m),
        v = n('mVfl'),
      ...
      var fe = u.d.a.withConfig({
        ...
        ge = { duration: 1e3, delay: 0, endDelay: 0, easing: 'easeOutElastic(1, .5)', round: 0 },
        ve = [
          'translateX',
          'translateY',
          'translateZ',
      ...
      function ke(e, t) {
        var n = Se(e),
          r = ye(Ee.und(n[0]) ? 1 : n[0], 0.1, 100),
          a = ye(Ee.und(n[1]) ? 100 : n[1], 0.1, 100),
          i = ye(Ee.und(n[2]) ? 10 : n[2], 0.1, 100),
          o = ye(Ee.und(n[3]) ? 0 : n[3], 0.1, 100),
          s = Math.sqrt(a / r),
          c = i / (2 * Math.sqrt(a * r)),
      ...
      function Fe(e, t) {
        var n = Re(e);
        for (var r in t) n[r] = Ee.und(e[r]) ? t[r] : e[r];
        return n;
      }
      function He(e) {
        return Ee.rgb(e)
      ...
      function nt(e, t) {
        var n = /[+-]?\d*\.?\d+(?:\.\d+)?(?:[eE][+-]?\d+)?/g,
          r = Ke(Ee.pth(e) ? e.totalLength : e, t) + '';
        return {
          original: r,
      ...
      function it(e, t) {
        ...
        return a
          .map(function (e, n) {
            var r = Ee.obj(e) && !Ee.pth(e) ? e : { value: e };
            return (
      ...
      function ot(e, t) {
                ...
                var t = Ne(
                  ...
                  r = function (r) {
                    ...
                    n[a] = e.map(function (e) {
                      var t = {};
                      for (var n in e) Ee.key(n) ? n == a && (t.value = e[n]) : (t[n] = e[n]);
                      return t;
                    });
                  },
                  a = 0;
        ...
        t))
          Ee.key(a) && n.push({ name: a, tweens: it(t[a], e) });
        return n;
      }
      function st(e, t) {
        var n;
      ...
      function bt(e, t) {
        for (var n = t.length; n--; ) Pe(e, t[n].animatable.target) && t.splice(n, 1);
      }
        ...
        (vt.stagger = function (e, t) {
          ...
          return function (e, t, v) {
            if ((s && (o = 0), c && (o = (v - 1) / 2), l && (o = v - 1), !m.length)) {
              for (var b = 0; b < v; b++) {
                if (a) {
                  var y = c ? (a[0] - 1) / 2 : o % a[0],
                    w = c ? (a[1] - 1) / 2 : Math.floor(o / a[0]),
                    x = y - (b % a[0]),
                    E = w - Math.floor(b / a[0]),
                    S = Math.sqrt(x * x + E * E);
      ...
      var yt = vt,
        ...
        Tt = u.d.header.withConfig({ displayName: 'nav__StyledHeader', componentId: 'ghklvd-0' })(
          [
            '',
        ...
        Mt = u.d.nav.withConfig({ displayName: 'nav__StyledNav', componentId: 'ghklvd-1' })(
          [
            '',
        ...
        Nt = u.d.div.withConfig({ displayName: 'nav__StyledLinks', componentId: 'ghklvd-2' })(
          [
      ...
      var Rt = u.d.div.withConfig({ displayName: 'menu__StyledMenu', componentId: 'sdn9y6-0' })([
          'display:none;@media (max-width:768px){display:block;}',
        ]),
        _t = u.d.button.withConfig({
        ...
        Ft = u.d.aside.withConfig({ displayName: 'menu__StyledSidebar', componentId: 'sdn9y6-2' })(
          [
            'display:none;@media (max-width:768px){',
        ...
        $t = function () {
          var e = Object(a.useState)({ stars: null, forks: null }),
            t = e[0],
            n = e[1];
          return (
            Object(a.useEffect)(function () {
        ...
        rn = u.d.div.withConfig({ displayName: 'about__StyledText', componentId: 'sc-1ownso9-1' })([
        ...
        an = u.d.div.withConfig({ displayName: 'about__StyledPic', componentId: 'sc-1ownso9-2' })(
          [
        ...
        on = function () {
          ...
          var n = ['JavaScript (ES6+)', 'HTML & (S)CSS', 'React', 'Vue', 'Node.js', 'WordPress'];
          return i.a.createElement(
            nn,
            { id: 'about', ref: t },
        ...
        ln = u.d.ul.withConfig({ displayName: 'jobs__StyledTabList', componentId: 'sc-59sdss-1' })([
        ...
        gn = function () {
          var e = hn.data.featured.edges.filter(function (e) {
              return e.node;
            }),
            t = Object(a.useRef)(null),
            n = Object(a.useRef)([]);
        ...
        wn = function () {
          ...
          var l = e.projects.edges.filter(function (e) {
              return e.node;
            }),
            u = l.slice(0, 6),
            d = n ? l : u;
    ...
    VeD8: function (e, t, n) {
          ...
          Object.keys(a).forEach(function (i) {
            ...
            if (Object(s.isValidElement)(o)) {
              var c = i in t,
                l = i in r,
                u = t[i],
                f = Object(s.isValidElement)(u) && !u.props.in;
              !l || (c && !f)
                ? l || !c || f
                  ? l &&
                    c &&
      ...
      var p =
        ...
        h = (function (e) {
          function t(t, n) {
            var r,
              a = (r = e.call(this, t, n) || this).handleExited.bind(o(o(r)));
            return (
        ...
        b = function (e) {
          ...
          if ('string' == typeof t && t.length > 2) {
            ...
            if (43 === i || 45 === i) {
              ...
              for (var o, c = t.slice(2), l = 0, u = c.length; l < u; l++)
                if ((o = c.charCodeAt(l)) < 48 || o > a) return NaN;
              return parseInt(c, r);
            }
          }
          return +t;
      ...
      e.exports =
        ...
        function (e, t) {
          var n = r(this),
            ...
            u = Math.min((void 0 === l ? o : a(l, o)) - c, o - s),
            d = 1;
          for (c < s && s < c + u && ((d = -1), (c += u - 1), (s += u - 1)); u-- > 0; )
    ...
    eMsz: function (e, t, n) {
      ...
      var r,
        ...
        y = (e.exports = n('94Pd')('WeakMap', v, b, l, !0, !0));
      f &&
        p &&
    ...
    nLfd: function (e, t, n) {
      ...
      function M(e, t) {
        ...
        var n = this.store.sequences[e.sequence.id],
          r = e.sequence.index;
        if (n) {
          var a = new L(n, 'visible', this.store),
      ...
      (Z.isSupported = function () {
        ...
        Z();
      var ee = 'undefined' == typeof window ? null : Z();
      t.a = ee;
    },
    'o/VY': function (e, t, n) {
      ...
      (function (e) {
        ...
        var G = function () {
          ...
          ne = function (e, t) {
            return function () {
              var n,
                r = (((n = {})[j] = K(t)), (n['data-styled-version'] = '4.4.1'), n),
                a = G();
              return (
                a && (r.nonce = a),
        ...
        var Ne = {
          ...
          ze = (((ke = {})[u.ForwardRef] = { $$typeof: !0, render: !0 }), ke),
    ...
    voZr: function (e, t, n) {
      ...
      function q(e, t, n, r, a, i) {
        ...
        for (var s = e[I]._b, c = o + e[M], l = r(+a), u = 0; u < t; u++)
          s[c + u] = l[i ? u : t - u - 1];
      }
      if (o.ABV) {
        if (
    ...
    ys0W: function (e, t, n) {
      ...
      e.exports = function (e) {
        return function (t) {
          for (var n, s = i(t), c = a(s), l = c.length, u = 0, d = []; l > u; )
            (n = c[u++]), (r && !o.call(s, n)) || d.push(e ? [n, s[n]] : s[n]);
          return d;
        };
      };
    },

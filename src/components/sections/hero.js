  ...
  const four = (
    <>
      <p>
        ...
        conducting cloud environment audits and local privilege escalation. Currently, I’m focused on securing the awesome products
        at{' '}
        <a href="https://zendesk.com/" target="_blank" rel="noreferrer">
          Zendesk
        </a>
        .
      </p>
